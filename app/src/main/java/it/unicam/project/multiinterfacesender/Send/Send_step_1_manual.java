 ...
 * {@link Send_step_1_manual.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Send_step_1_manual#newInstance} factory method to
...
public class Send_step_1_manual extends Fragment {
    ...
    public void updateTextInputByChoosenInterfaces() {
        ...
        TextInputLayout mobileLayout = getActivity().findViewById(R.id.input_layout_remote_ip);
